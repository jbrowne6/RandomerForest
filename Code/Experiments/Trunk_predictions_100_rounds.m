...
Xtrain = csvread('~/RandomerForest/Data/Trunk/Trunk_Xtrain.dat');
Ytrain = cellstr(num2str(csvread('~/RandomerForest/Data/Trunk/Trunk_Ytrain.dat')));
Xtest = csvread('~/RandomerForest/Data/Trunk/Trunk_Xtest.dat');
Ytest = csvread('~/RandomerForest/Data/Trunk/Trunk_Ytest.dat');
